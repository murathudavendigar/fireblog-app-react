    ...
    <>
      <section className="h-screen -mt-11">
        <div className="px-6 h-full text-gray-800 ">
          <section className="flex items-center justify-center mt-11 -mb-5 hidden lg:inline-block">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center ">
                  ...
                  <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                    ...
                    <Link
                      to="/login"
                      className="text-white hover:text-green-700 focus:text-green-700 transition duration-200 ease-in-out">
                      Login
                    </Link>
                  </p>
                </div>
